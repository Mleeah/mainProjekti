...
def ongoingBattle(driver, attackCombos):
    tries = 15
    while driver.find_element(By.XPATH, "/html/div[11]/div[1]/div/table[3]/tbody/tr/td").text != "Команды":
        #/html/div[10]/div[1]/div/table[3]/tbody/tr/td
        #/html/div[11]/div[1]/div/table[3]/tbody/tr/td
        #/html/div[11]/div[1]/div/table[3]/tbody/tr/td
        if(tries < 0 ):
